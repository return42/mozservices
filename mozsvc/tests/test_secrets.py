...
class TestSecrets(unittest.TestCase):
    ...
    def test_read_write(self):
        ...
        self.assertTrue(len(secrets2.get('phx23456')) == 2)
        self.assertTrue(len(secrets2.get('phx23')) == 1)
        self.assertTrue(secrets2.get('phx23456') == phx23456_secrets)
    ...
    def test_fixed_secrets(self):
        ...
        self.assertTrue(secrets.get('phx123') == ['one', 'two'])
        self.assertTrue(secrets.get('phx234') == ['one', 'two'])
